...
- (void)testValidate
{
    NSString *fileName = @"/Users/kyontan/Code/remote/twitter-text/objc/test/json-conformance/validate.json";
    NSData *data = [NSData dataWithContentsOfFile:fileName];
    if (!data) {
        XCTFail(@"No test data: %@", fileName);
        return;
...
- (void)testTlds
{
  NSLog(@"%@", [[NSFileManager new] currentDirectoryPath]);
  
    NSString *fileName = @"/Users/kyontan/Code/remote/twitter-text/objc/test/json-conformance/tlds.json";
    NSData *data = [NSData dataWithContentsOfFile:fileName];
    if (!data) {
        XCTFail(@"No test data: %@", fileName);
        return;
